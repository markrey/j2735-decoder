...
asn_TYPE_descriptor_t asn_DEF_snapshots_7 = {
	...
	{ &asn_OER_type_snapshots_constr_7, &asn_PER_type_snapshots_constr_7, SEQUENCE_OF_constraint },
	asn_MBR_snapshots_7,
	1,	/* Single element */
...
asn_TYPE_member_t asn_MBR_ProbeVehicleData_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct ProbeVehicleData, snapshots),
		...
		&asn_DEF_snapshots_7,
		0,
		{ &asn_OER_memb_snapshots_constr_7, &asn_PER_memb_snapshots_constr_7,  memb_snapshots_constraint_1 },
		0, 0, /* No default value */
		"snapshots"
		},
