...
select_PartIIcontent_143P0_partII_Value_type(const asn_TYPE_descriptor_t *parent_type, const void *parent_sptr) {
	asn_type_selector_result_t result = {0, 0};
	const asn_ioc_set_t *itable = asn_IOS_BSMpartIIExtension_1;
	size_t constraining_column = 0; /* &id */
	size_t for_column = 1; /* &Type */
	size_t row;
	const long *constraining_value = (const long *)((const char *)parent_sptr + offsetof(struct PartIIcontent_143P0, partII_Id));
...
static asn_TYPE_member_t asn_MBR_partII_Value_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_143P0__partII_Value, choice.VehicleSafetyExtensions),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_143P0__partII_Value, choice.SpecialVehicleExtensions),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_143P0__partII_Value, choice.SupplementalVehicleExtensions),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_partII_Value_specs_3 = {
	sizeof(struct PartIIcontent_143P0__partII_Value),
	offsetof(struct PartIIcontent_143P0__partII_Value, _asn_ctx),
	offsetof(struct PartIIcontent_143P0__partII_Value, present),
	sizeof(((struct PartIIcontent_143P0__partII_Value *)0)->present),
...
asn_TYPE_member_t asn_MBR_PartIIcontent_143P0_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_143P0, partII_Id),
	...
	{ ATF_OPEN_TYPE | ATF_NOFLAGS, 0, offsetof(struct PartIIcontent_143P0, partII_Value),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_partII_Value_3,
		select_PartIIcontent_143P0_partII_Value_type,
		{ &asn_OER_memb_partII_Value_constr_3, &asn_PER_memb_partII_Value_constr_3,  memb_partII_Value_constraint_1 },
		0, 0, /* No default value */
		"partII-Value"
		},
};
static const ber_tlv_tag_t asn_DEF_PartIIcontent_143P0_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_PartIIcontent_143P0_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* partII-Id */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* partII-Value */
};
asn_SEQUENCE_specifics_t asn_SPC_PartIIcontent_143P0_specs_1 = {
	sizeof(struct PartIIcontent_143P0),
	offsetof(struct PartIIcontent_143P0, _asn_ctx),
	asn_MAP_PartIIcontent_143P0_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_PartIIcontent_143P0 = {
	"PartIIcontent",
	"PartIIcontent",
	&asn_OP_SEQUENCE,
	asn_DEF_PartIIcontent_143P0_tags_1,
	sizeof(asn_DEF_PartIIcontent_143P0_tags_1)
		/sizeof(asn_DEF_PartIIcontent_143P0_tags_1[0]), /* 1 */
	asn_DEF_PartIIcontent_143P0_tags_1,	/* Same as above */
	sizeof(asn_DEF_PartIIcontent_143P0_tags_1)
		/sizeof(asn_DEF_PartIIcontent_143P0_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_PartIIcontent_143P0_1,
	2,	/* Elements count */
	&asn_SPC_PartIIcontent_143P0_specs_1	/* Additional specs */
};
